...
installDependenciesDeb() {
    ...
    (sudo apt install build-essential cmake vim-nox python3-dev mono-complete golang nodejs default-jdk npm -y) || (echo "Error: could not install dependencies! Exiting script..."; exit 0)
